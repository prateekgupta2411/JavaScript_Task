...
const countStudentsAbove60InScience = students.reduce((count, student) => {
...
console.log("Number of students who scored more than 60 in science:", countStudentsAbove60InScience);
