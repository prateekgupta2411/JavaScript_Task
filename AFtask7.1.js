...
const filteredArray = jsonData.filter(obj => obj.country === "India");
console.log(filteredArray);

const firstIndian = jsonData.find(obj => obj.country === "India");
console.log(firstIndian);

const index = jsonData.findIndex(obj => obj.country === "India");
console.log(index);
