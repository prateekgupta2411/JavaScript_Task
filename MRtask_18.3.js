...
const highestEnglishScorer = students.reduce((highestScorer, student) => {
    if (student.english > highestScorer.english) {
        return student;
    } else {
        return highestScorer;
    }
});
console.log("Student with the highest marks in English:", highestEnglishScorer);
